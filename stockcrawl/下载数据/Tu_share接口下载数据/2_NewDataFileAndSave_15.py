...
StockDatapath = 'd:\\StockFile\\StockData_15_New'
StockDatapath15 = 'd:\\StockFile\\StockData_15_new'
...
def GetAllDataAndSave(DataFiles, SavePath):
    ...
    for StockCode in FileList['code']:
        ...
        try:
            StockData = ts.get_k_data(strStoceCade, OriginalDay, today,ktype='15')
        except:
            print('Error')
        else:
...
if __name__=="__main__":
    GetAllDataAndSave(DataFile,StockDatapath15)
