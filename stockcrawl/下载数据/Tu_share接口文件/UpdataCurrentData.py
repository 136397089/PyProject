...
def UpdateData(fileData,stockcode,currentData):
    ...
    newindexname = str(cur.year) + '-' + str(cur.month).zfill(2) + '-' + str(cur.day).zfill(2) + ' '+ str(cur.hour).zfill(2)+':'+str(cur.minute).zfill(2)
...
if __name__=="__main__":
    ...
    sourceFilePath = 'd://StockFile//StockData_60'
    WhereaboutsFilePath = 'd://StockFile//StockData_60_Current//'
    print('begin '+sourceFilePath)
    UpdataCurrentDataFiles(CurrentData,sourceFilePath,WhereaboutsFilePath)
    sourceFilePath = 'd://StockFile//StockData_30'
    WhereaboutsFilePath = 'd://StockFile//StockData_30_Current//'
    print('begin '+sourceFilePath)
    UpdataCurrentDataFiles(CurrentData,sourceFilePath,WhereaboutsFilePath)
